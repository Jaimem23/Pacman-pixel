...
fruit_ID = {"1": (0, 176), "2": (16, 176), "3": (32,176), "4": (48, 176), "5":(64, 176)} #Internal naming of the fruits: 1.Cherry 2.Raspberry 3.Orange 4.Apple 5.Watermelon
selected_fruit = 1
...
def fruit_spawn():
   ...
   fruit_object.x_pos_tile = fruit_ID[str(selected_fruit)][0]
   fruit_object.y_pos_tile = fruit_ID[str(selected_fruit)][1]
   fruit_object.fruit_number = selected_fruit

#Create a fruit object (Cherry by default)
fruit_object = Fruit(FRUIT_X_POS, FRUIT_Y_POS, 16, 16, False, 0, 176,selected_fruit)
